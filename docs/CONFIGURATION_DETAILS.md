...
- Google Workspace CLI keys for delegated calendar writes (`GWS_ACCOUNT`, `GWS_IMPERSONATED_EMAIL`, `GWS_SCOPE`, `GWS_CALENDAR_ID`, `GWS_SERVICE_ACCOUNT_KEY_FILE`, `GOOGLE_WORKSPACE_CLI_CONFIG_DIR`, `GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE`, `GOOGLE_WORKSPACE_CLI_ENCRYPTION_KEY_FILE`, `GOOGLE_WORKSPACE_CLI_TOKEN_FILE`, `GOOGLE_WORKSPACE_CLI_NO_KEYRING`; legacy `DAVIS_GWS_*` still supported)
