...
- Google Workspace CLI keys for delegated calendar writes (`DAVIS_GWS_ACCOUNT`, `DAVIS_GWS_IMPERSONATED_EMAIL`, `DAVIS_GWS_SCOPE`, `DAVIS_GWS_CALENDAR_ID`, `DAVIS_GWS_SERVICE_ACCOUNT_KEY_FILE`, `GOOGLE_WORKSPACE_CLI_CONFIG_DIR`, `GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE`, `GOOGLE_WORKSPACE_CLI_ENCRYPTION_KEY_FILE`, `GOOGLE_WORKSPACE_CLI_TOKEN_FILE`, `GOOGLE_WORKSPACE_CLI_NO_KEYRING`)
