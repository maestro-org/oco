...
- Every task should have owner, status, and due date.
- Escalate blockers with options and tradeoffs.
- Close loops by reporting completed outcomes.
...
1. Confirm scope and urgency.
2. Pull current state from source systems.
3. Return decision-ready summary with owners and deadlines.
